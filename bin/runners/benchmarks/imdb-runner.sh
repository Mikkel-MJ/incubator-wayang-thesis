...
echo "Running JOBenchmark"
    ...
    #    query="$test_path/${query_name}.sql"
        ...
        #timeout --kill-after=30m --foreground 30m ./bin/wayang-submit -Xmx32g org.apache.wayang.ml.benchmarks.JOBenchmark java,spark,flink,postgres file://$data_path/ $timings_path/bvae/retrained/1/ $query bvae /work/lsbo-paper/python-ml/src/Models/imdb/retrained/bvae-1.onnx $data_path/experience/
        #timeout --kill-after=30m --foreground 30m ./bin/wayang-submit -Xmx32g org.apache.wayang.ml.benchmarks.JOBenchmark java,spark,flink,postgres file://$data_path/ $timings_path/bvae/retrained/2/ $query bvae /work/lsbo-paper/python-ml/src/Models/imdb/retrained/bvae-2.onnx $data_path/experience/
