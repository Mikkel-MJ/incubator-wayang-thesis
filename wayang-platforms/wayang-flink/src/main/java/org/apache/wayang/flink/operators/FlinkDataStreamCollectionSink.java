 ...
 */
public class FlinkDataStreamCollectionSink<T> extends UnaryToUnaryOperator<T, T> implements FlinkExecutionOperator {
    public FlinkDataStreamCollectionSink(final DataSetType<T> inputType) {
