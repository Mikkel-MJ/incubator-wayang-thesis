...
public class JavaJoinOperator<InputType0, InputType1, KeyType>
     ...
     */
    public JavaJoinOperator(final DataSetType<InputType0> inputType0,
            final DataSetType<InputType1> inputType1,
            final TransformationDescriptor<InputType0, KeyType> keyDescriptor0,
            final TransformationDescriptor<InputType1, KeyType> keyDescriptor1) {
     ...
     */
    public JavaJoinOperator(final JoinOperator<InputType0, InputType1, KeyType> that) {
        super(that);
    }
    ...
    public Tuple<Collection<ExecutionLineageNode>, Collection<ChannelInstance>> evaluate(
        ...
        System.out.println("[evaluate] executing java join: " + this);
        ...
        if (isMaterialize0) {
            ...
            final Map<KeyType, Collection<InputType0>> probeTable = new HashMap<>(expectedNumElements);
            ((JavaChannelInstance) inputs[0]).<InputType0>provideStream()
            ...
            joinStream = ((JavaChannelInstance) inputs[1]).<InputType1>provideStream()
            ...
            final Map<KeyType, Collection<InputType1>> probeTable = new HashMap<>(expectedNumElements);
            ((JavaChannelInstance) inputs[1]).<InputType1>provideStream()
            ...
            joinStream = ((JavaChannelInstance) inputs[0]).<InputType0>provideStream()
