...
import org.apache.wayang.postgres.operators.PostgresCartesianOperator;
...
/**
 * Cartesian operator mapping for postgres
 */
public class CartesianMapping implements Mapping {
    ...
    private ReplacementSubplanFactory createReplacementSubplanFactory() {
        return new ReplacementSubplanFactory.OfSingleOperators<CartesianOperator<Record, Record>>(
                (matchedOperator, epoch) -> new PostgresCartesianOperator(matchedOperator).at(epoch)
        );
    }
}
