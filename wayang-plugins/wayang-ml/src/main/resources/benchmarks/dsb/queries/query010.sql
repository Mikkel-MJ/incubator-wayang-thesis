...
select 
      ...
      count(*) cnt6
from postgres.customer AS c, postgres.customer_address AS ca, postgres.customer_demographics
where
      ...
      and cd_gender = 'M' 
      and exists (select *
            from postgres.store_sales, postgres.date_dim, postgres.item
      ...
      and (exists (select *
            from postgres.web_sales, postgres.date_dim, postgres.item
      ...
      or exists (select *
            from postgres.catalog_sales, postgres.date_dim, postgres.item
